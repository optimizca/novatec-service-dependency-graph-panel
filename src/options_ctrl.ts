...
export class OptionsCtrl {
	...
	getExternalIconOptions() {
		...
		return ['application_generic', 'application_svc', 'aws_logo', 'azure_logo', 'cluster', 'database', 'docker_container', 'firewall', 'ip', 'java', 'k8s_logo', 'k8s_pod', 'k8s-pod-256','plugin','redhat_logo', 'router','server_generic','storage','switch','virtual_machine','vsphere','web_plugin','web_svc','web','windows_logo','windows_server'];
	}
